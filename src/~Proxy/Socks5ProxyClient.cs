...
public sealed class Socks5ProxyClient : ProxyClient
{
    ...
    private void HandleCommandError(byte command)
    {
        ...
        {
            AuthMethodReplyNoAcceptableMethods => Resources.Socks5_AuthMethodReplyNoAcceptableMethods,
            CommandReplyGeneralSocksServerFailure => Resources.Socks5_CommandReplyGeneralSocksServerFailure,
            CommandReplyConnectionNotAllowedByRuleset => Resources.Socks5_CommandReplyConnectionNotAllowedByRuleset,
            CommandReplyNetworkUnreachable => Resources.Socks5_CommandReplyNetworkUnreachable,
            CommandReplyHostUnreachable => Resources.Socks5_CommandReplyHostUnreachable,
            CommandReplyConnectionRefused => Resources.Socks5_CommandReplyConnectionRefused,
            CommandReplyTTLExpired => Resources.Socks5_CommandReplyTTLExpired,
            CommandReplyCommandNotSupported => Resources.Socks5_CommandReplyCommandNotSupported,
            CommandReplyAddressTypeNotSupported => Resources.Socks5_CommandReplyAddressTypeNotSupported,
